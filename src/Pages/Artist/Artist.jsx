...
export default function Artist() {
  ...
  return (
    <div>
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0), rgba(0,0,0,0.9)), url(${header_image_url ? header_image_url : img }) `,
        ...
        <div className={styles.container}>
          <div className={styles.heroTop}>
            <div className={styles.artistImage}>
              <img src={image_url ? image_url : img } alt="" />
            </div>
      ...
      <div className={styles.artistSongs}>
        <div className= {styles.container}>
          ...
          artistSongs.length > 0 ?
           artistSongs.slice(0, 14).map(item => (
              <SingleMusic
                key={item.key}
                songID={item.key}
                title={item.title}
